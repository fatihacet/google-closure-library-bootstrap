...
goog.ui.Dialog.prototype.onTitleCloseClick_ = function(e) {
  ...
  if (key && key != goog.ui.Dialog.DefaultButtonKeys.OK) {
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_OK_ = goog.getMsg('Tamam');
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_CANCEL_ = goog.getMsg('Vazgeç');
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_YES_ = goog.getMsg('Evet');
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_NO_ = goog.getMsg('Hayır');
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_SAVE_ = goog.getMsg('Kaydet');
 ...
 * @private
 */
goog.ui.Dialog.MSG_DIALOG_CONTINUE_ = goog.getMsg('Devam Et');
